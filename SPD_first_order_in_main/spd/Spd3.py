...
tau_lst = [0,0.125,0.25,0.375,0.5,0.75,1,1.5,2]
...
np.save('spd_3_pval_debias' +'_tau_'+str(s1)+'_T_'+str(s2)+'.npy', pval1)
np.save('spd_3_pval_bias' + '_tau_'+str(s1)+'_T_'+str(s2)+'.npy', pval2)
end1=time.time()
print(end1-start1)
p.terminate()
